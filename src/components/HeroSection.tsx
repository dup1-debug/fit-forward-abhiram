...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-start overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-charcoal-900/95 via-charcoal-900/70 to-charcoal-900/40"></div>
      </div>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-charcoal-900/95 to-charcoal-900/80"></div>
      </div>
        ...
        <div className="md:hidden">
          <div className="text-white space-y-6 animate-fade-in text-center">
            <div className="space-y-4">
               <h1 className="text-3xl font-bold leading-tight uppercase tracking-tight font-helvetica">
                 Hi, I'm <span className="text-forest-green-500 tracking-wide block mt-1 font-extrabold">Abhiram</span>
               </h1>
              <p className="text-base text-gray-100 font-medium leading-relaxed mx-auto px-2 font-zt-formom">
            ...
            <div className="pt-4">
             ...
             <div className="grid grid-cols-3 gap-2 pt-6 mt-6 border-t border-white/20">
               <div className="bg-charcoal-900/40 backdrop-blur-sm rounded-xl p-3 transform hover:scale-105 transition-all duration-300">
                 <div className="text-2xl font-bold mb-1 text-forest-green-500">500+</div>
                 <div className="text-xs text-gray-200 font-medium font-zt-formom">TRANSFORMED</div>
               </div>
               <div className="bg-charcoal-900/40 backdrop-blur-sm rounded-xl p-3 transform hover:scale-105 transition-all duration-300">
                 <div className="text-2xl font-bold mb-1 text-sky-blue-400">95%</div>
                 <div className="text-xs text-gray-200 font-medium font-zt-formom">SUCCESS RATE</div>
               </div>
               <div className="bg-charcoal-900/40 backdrop-blur-sm rounded-xl p-3 transform hover:scale-105 transition-all duration-300">
                 <div className="text-2xl font-bold text-white mb-1">24/7</div>
                 <div className="text-xs text-gray-200 font-medium font-zt-formom">SUPPORT</div>
               </div>
             </div>
          </div>
        </div>
          ...
          <div className="text-stone-100 space-y-8 animate-fade-in">
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl font-black leading-[0.9] uppercase tracking-tight font-helvetica">
                Your body deserves<span className="text-forest-green-500 font-extrabold"> better.</span>
                <br />
                So do<span className="text-white font-extrabold"> you.</span>
              </h1>
              <div className="space-y-3">
                <p className="text-lg text-gray-200 font-medium font-zt-formom">
            ...
            <div className="grid grid-cols-3 gap-8 pt-12 max-w-2xl">
              <div className="transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl font-bold mb-2 text-forest-green-500">500+</div>
                <div className="text-sm text-gray-200 font-medium font-zt-formom">TRANSFORMED</div>
              </div>
              <div className="transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl font-bold mb-2 text-sky-blue-400">95%</div>
                <div className="text-sm text-gray-200 font-medium font-zt-formom">SUCCESS RATE</div>
              </div>
              <div className="transform hover:scale-110 transition-transform duration-300">
                <div className="text-4xl font-bold text-white mb-2">24/7</div>
                <div className="text-sm text-gray-200 font-medium font-zt-formom">SUPPORT</div>
              </div>
            </div>
          </div>
        </div>
